...
public class LoginController implements CommunityConstant {
    ...
    public String register(Model model, User user) {
        ...
        if (map == null || map.isEmpty()) {
            model.addAttribute("msg", "Registration successful! We have sent an activation email to your mailbox. Please activate your account as soon as possible");
    ...
    public String activation(Model model, @PathVariable("userId") int userId, @PathVariable("code") String code) {
        ...
        if (result == ACTIVATION_SCUUESS) {
            model.addAttribute("msg", "Activation successful! Your account is now fully operational");
    ...
    public void getKaptcha(HttpServletResponse response, HttpSession session) throws IOException {
        ...
        try {
            ...
            logger.error("Response to verification code failed" + e.getMessage());
        }
    }
    ...
    public String login(Model model, String username, String password, String code, boolean rememberMe, HttpSession session, HttpServletResponse response) {
        ...
        if (StringUtils.isBlank(kaptcha) || StringUtils.isBlank(code) || !kaptcha.equalsIgnoreCase(code)) {
            model.addAttribute("codeMsg", "Validation code is wrong!");
            return "/site/login";
        }
